...
def train():
  """Train a en->cn translation model."""
...
def decode(originalText):
      ...
      if model is None:
        ...
        # Load vocabularies.
        en_vocab_path = os.path.join(FLAGS.train_dir, "vocab%d.en" % FLAGS.en_vocab_size)
        cn_vocab_path = os.path.join(FLAGS.train_dir, "vocab%d.cn" % FLAGS.cn_vocab_size)
        en_vocab, _ = data_utils.initialize_vocabulary(en_vocab_path, data_utils.basic_decoder)
        _, rev_cn_vocab = data_utils.initialize_vocabulary(cn_vocab_path, data_utils.chinese_decoder)

      # Get token-ids for the input originalText.
      token_ids = data_utils.sentence_to_token_ids(originalText, en_vocab, data_utils.basic_decoder)
